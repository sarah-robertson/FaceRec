// KF6019faceDetect.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, const char** argv)
{
	...
	//XML classifiers with facial features
	CascadeClassifier cascade, nestedCascade;
	double scale = 1;

	// Loading the classifiers from opencv directory
	...
	if (capture.isOpened())
	{
		// Capture frames from video and detect a face
	...
	double scale)
{
	...
	for (size_t i = 0; i < faces.size(); i++)
	{
		...
		// Detection of eyes in input image
